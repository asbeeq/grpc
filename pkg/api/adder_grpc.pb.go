...
type AdderClient interface {
	...
	Sub(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*AddResponse, error)
}
...
func (c *adderClient) Sub(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*AddResponse, error) {
	out := new(AddResponse)
...
type AdderServer interface {
	...
	Sub(context.Context, *AddRequest) (*AddResponse, error)
}
...
func (UnimplementedAdderServer) Sub(context.Context, *AddRequest) (*AddResponse, error) {
...
func _Adder_Sub_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdderServer).Sub(ctx, req.(*AddRequest))
	}
	return interceptor(ctx, in, info, handler)
}
